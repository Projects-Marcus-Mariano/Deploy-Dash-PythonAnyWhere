...
app.layout = dbc.Container(children = [
    dbc.Row([
        ...
        # dcc.Checklist(fig_map, id="fig_map"), 
    ]),
    dbc.Row([
        dbc.Col(radio_list, xs=4, sm=4, md=4, lg=2, xl=2,id='radio_list'),
...
def update_graph(az, fl, ga, ia, me, mi, nc, nv, oh, pa, tx, wi):
    dff = data.copy()  # assign party to dataframe (long_code.py lines 55-57)
